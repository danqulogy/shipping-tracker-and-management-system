...
<div class="container">
    <div class="row jumbotron">
        ...
        <div class="col-lg-12 row">
            <div class="col"></div>
            <form method="post" action="{{'/agents/edit/'.$agent->id}}" class="col-lg-6 modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Update <small class="bg-info text-bold padding5 curvy fg-white" >{{$agent->full_name}}</small> Details</h5>
                ...
                <div class="modal-body">
                    <div>
                        ...
                        <div class="form-group {{$errors->has('email') ? ' has-error' : '' }}">
                            ...
                            <input type="text" value="{{$agent->first_name}}" required class="form-control" id="first_name" name="first_name">
                        ...
                        <div class="form-group {{$errors->has('other_names') ? ' has-error' : '' }}">
                            ...
                            <input type="text" value="{{$agent->other_names}}" pattern="^[a-zA-Z- ]{2,50}$" required class="form-control" name="other_names" id="other_names">
                        ...
                        <div class="form-group {{$errors->has('phone_number') ? ' has-error' : '' }}">
                            ...
                            <input type="text" minlength="10" maxlength="10" value="{{$agent->phone_number}}" required class="form-control" name="phone_number" id="phone_number">
                        ...
                        <div class="form-group {{$errors->has('email') ? ' has-error' : '' }}">
                            ...
                            <input type="text" value="{{$agent->email}}" required class="form-control" name="email" id="email">
                            @if ($errors->has('email'))
                                <span class="help-block">
                ...
                <div class="modal-footer">
                    <a href="{{url('/home')}}" class="btn btn-secondary" data-dismiss="modal">Go Back</a>
                    <button type="submit" class="btn btn-primary">Update Agent Details</button>
                </div>
            </form>
            <div class="col"></div>
        </div>
