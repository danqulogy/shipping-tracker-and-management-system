...
@section('content')
    {{--Add new Agent Modal--}}
    <form method="post" action="{{url('/agents/register')}}" class="modal fade" id="addNewAgentModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"><i class="fa fa-plus"></i> Register new Agent</h5>
...
<div class="container">
    <div class="row jumbotron">
        ...
        <div class="col-lg-12" style="display: flex;">
            <h3 s style="margin-top: -30px; flex: 2"> Agents Listings</h3>
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addNewAgentModal" style="margin-top: -30px">
            ...
            <table class="table table-striped uppercase table-hover">
                ...
                <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group" role="group" aria-label="">
                                        {{--<button class="bt btn-success"><i class="fa fa-send"></i> Transactions</button>--}}
                                        <a href="{{url('/agents/edit/'.$agent->id)}}" class="btn btn-primary">
                                            <i class="fa fa-edit"></i> Edit Agent</a>
                                        <a href="{{url('/agents/delete/'.$agent->id)}}" class="btn btn-danger">
                    ...
                    @else
                        <tr>
                            <td colspan="4">
                                <p class="text-bold align-center fg-green"> There are currently no agents registered!</p>
                            </td>
                        </tr>
                    @endif
                </tbody>
